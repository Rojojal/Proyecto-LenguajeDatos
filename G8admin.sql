...
-- Fecha: 25/07/2024
-- crear categoria
CREATE OR REPLACE PROCEDURE categoria_insertar_SP(
...
CREATE OR REPLACE PROCEDURE categoria_eliminar_SP(
...
-- Fecha: 25/07/2024
-- actualiza categoria
CREATE OR REPLACE PROCEDURE categoria_actualizar_nombre_SP(
P_nombre_categoria IN G8admin.FIDE_categoria_TB.nombre_categoria%TYPE,
...
-- Fecha: 25/07/2024
-- crear detalle
CREATE OR REPLACE PROCEDURE detalle_insertar_SP(
...
CREATE OR REPLACE PROCEDURE detalle_eliminar_SP(
...
-- Fecha: 25/07/2024
-- actualiza detalle
CREATE OR REPLACE PROCEDURE detalle_actualizar_SP(
...
-- Fecha: 11/08/2024
-- Crear pais
CREATE OR REPLACE PROCEDURE pais_insertar_SP(
...
-- Fecha: 11/08/2024
-- Eliminar paises
CREATE OR REPLACE PROCEDURE pais_eliminar_SP(
P_id_pais IN number
)
IS
BEGIN
...
-- Fecha: 11/08/2024
-- Actualizar paises
CREATE OR REPLACE PROCEDURE pais_actualizar_SP(
...
-- Fecha: 11/08/2024
-- Crear roles
CREATE OR REPLACE PROCEDURE rol_insertar_SP(
...
-- Fecha: 11/08/2024
-- Eliminar roles
CREATE OR REPLACE PROCEDURE roles_eliminar_SP(
P_id_rol IN number
)
IS
BEGIN
...
-- Fecha: 11/08/2024
-- Actualizar roles
CREATE OR REPLACE PROCEDURE rol_actualizar_SP(
...
-- Fecha: 11/08/2024
-- Crear capitanes
CREATE OR REPLACE PROCEDURE capitan_insertar_SP(
...
-- Fecha: 11/08/2024
-- Eliminar capitanes
CREATE OR REPLACE PROCEDURE capitan_eliminar_SP(
...
CREATE OR REPLACE PROCEDURE capitan_actualizar_SP(
...
-- Fecha: 11/08/2024
-- Crear buque
CREATE OR REPLACE PROCEDURE buque_insertar_SP(
...
-- Fecha: 11/08/2024
-- Eliminar buque
CREATE OR REPLACE PROCEDURE buque_eliminar_SP(
...
-- Fecha: 11/08/2024
-- Actualizar buque
CREATE OR REPLACE PROCEDURE buque_actualizar_SP(
    P_id_buque IN G8admin.FIDE_buque_TB.id_buque%TYPE,
    P_nombre_barco IN G8admin.FIDE_buque_TB.nombre_barco%TYPE,
    P_estado_buque IN G8admin.FIDE_buque_TB.estado_buque%TYPE,
    P_capacidad_maxima IN G8admin.FIDE_buque_TB.capacidad_maxima%TYPE,
...
-- Fecha: 12/08/2024
-- Crear empleado
CREATE OR REPLACE PROCEDURE empleado_insertar_SP(
...
-- Fecha: 12/08/2024
-- Eliminar empleado
CREATE OR REPLACE PROCEDURE empleado_eliminar_SP(
...
-- Fecha: 12/08/2024
-- Actualizar empleado
CREATE OR REPLACE PROCEDURE empleado_actualizar_SP(
    P_id_empleado IN G8admin.FIDE_empleado_TB.id_empleado%TYPE,
    P_nombre IN G8admin.FIDE_empleado_TB.nombre%TYPE
)
IS
...
-- Fecha: 12/08/2024
-- Crear almacén
CREATE OR REPLACE PROCEDURE almacen_insertar_SP(
...
CREATE OR REPLACE PROCEDURE almacen_eliminar_SP(
...
-- Fecha: 12/08/2024
-- Actualizar almacén
CREATE OR REPLACE PROCEDURE almacen_actualizar_SP(
...
-- Fecha: 12/08/2024
-- Crear inventario
CREATE OR REPLACE PROCEDURE inventario_insertar_SP(
...
CREATE OR REPLACE PROCEDURE inventario_eliminar_SP(
...
CREATE OR REPLACE PROCEDURE inventario_actualizar_SP(
...
-- Fecha: 12/08/2024
-- Crear destino
CREATE OR REPLACE PROCEDURE destino_insertar_SP(
...
CREATE OR REPLACE PROCEDURE destino_eliminar_SP(
...
-- Fecha: 12/08/2024
-- Actualizar destino
CREATE OR REPLACE PROCEDURE destino_actualizar_SP(
    P_id_destino IN G8admin.FIDE_destino_TB.id_destino%TYPE,
    P_nombre_puerto IN G8admin.FIDE_destino_TB.nombre_puerto%TYPE,
    P_fecha_partida IN G8admin.FIDE_destino_TB.fecha_partida%TYPE,
    P_fecha_llegada IN G8admin.FIDE_destino_TB.fecha_llegada%TYPE,
...
-- Fecha: 12/08/2024
-- Crear usuario
CREATE OR REPLACE PROCEDURE usuario_insertar_SP(
...
CREATE OR REPLACE PROCEDURE usuario_eliminar_SP(
...
-- Fecha: 12/08/2024
-- Actualizar usuario
CREATE OR REPLACE PROCEDURE usuario_actualizar_SP(
    P_id_usuario IN G8admin.FIDE_usuario_TB.id_usuario%TYPE,
    P_primer_nombre IN G8admin.FIDE_usuario_TB.primer_nombre%TYPE,
    P_apellido IN G8admin.FIDE_usuario_TB.apellido%TYPE,
    P_username IN G8admin.FIDE_usuario_TB.username%TYPE,
...
-- Fecha: 13/08/2024
-- Crear contenedor
CREATE OR REPLACE PROCEDURE contenedor_insertar_SP(
...
CREATE OR REPLACE PROCEDURE contenedor_eliminar_SP(
...
CREATE OR REPLACE PROCEDURE contenedor_actualizar_SP(
    P_id_contenedor IN G8admin.FIDE_contenedor_TB.id_contenedor%TYPE,
    P_peso_neto IN G8admin.FIDE_contenedor_TB.peso_neto%TYPE,
    P_estado_contenedor IN G8admin.FIDE_contenedor_TB.estado_contenedor%TYPE,
    P_peso_maximo IN G8admin.FIDE_contenedor_TB.peso_maximo%TYPE,
...
CREATE OR REPLACE PROCEDURE contenedor_producto_insertar_SP(
...
CREATE OR REPLACE PROCEDURE contenedor_producto_eliminar_SP(
    P_id_contenedor IN G8admin.FIDE_contenedor_producto_TB.id_contenedor%TYPE,
    P_id_producto IN G8admin.FIDE_contenedor_producto_TB.id_producto%TYPE
)
IS
...
CREATE OR REPLACE PROCEDURE contenedor_producto_actualizar_SP(
    P_id_contenedor IN G8admin.FIDE_contenedor_producto_TB.id_contenedor%TYPE,
    P_id_producto IN G8admin.FIDE_contenedor_producto_TB.id_producto%TYPE,
    P_cantidad_producto IN G8admin.FIDE_contenedor_producto_TB.cantidad_producto%TYPE
)
...
CREATE OR REPLACE FUNCTION FIDE_buque_TB_buscar_estado_FN(
    P_id_buque IN G8admin.FIDE_buque_TB.id_buque%TYPE
...
CREATE OR REPLACE FUNCTION FIDE_capitan_TB_calcular_edad_FN(
    P_id_capitan IN G8admin.FIDE_capitan_TB.id_capitan%TYPE
...
CREATE OR REPLACE FUNCTION FIDE_producto_TB_calcular_iva_FN(
    P_precio IN G8admin.FIDE_producto_TB.precio%TYPE,
...
CREATE OR REPLACE FUNCTION FIDE_buque_TB_calcular_peso_FN(
    P_id_buque IN G8admin.FIDE_buque_TB.id_buque%TYPE
...
CREATE OR REPLACE FUNCTION FIDE_contenedor_producto_TB_cantidad_producto_FN(
...
CREATE OR REPLACE FUNCTION FIDE_capitan_TB_calcular_experiencia_FN(
    P_id_capitan IN G8admin.FIDE_capitan_TB.id_capitan%TYPE
...
CREATE OR REPLACE FUNCTION FIDE_usuario_TB_ver_region_usuarios_FN(
    P_nacionalidad IN G8admin.FIDE_usuario_TB.nacionalidad%TYPE
...
CREATE OR REPLACE FUNCTION FIDE_inventario_TB_cantidad_producto_FN(
    P_id_inventario IN G8admin.FIDE_inventario_TB.id_inventario%TYPE
...
BEGIN
    G8admin.rol_insertar_sp('admin');
    G8admin.rol_insertar_sp('user');
END;
...
BEGIN
    contenedor_insertar_SP(15.50, 'Activo', 20.00, 1500.00, 45, 75, 3);
    contenedor_insertar_SP(18.75, 'Activo', 25.00, 2000.00, 101, 65, 6);
    contenedor_insertar_SP(22.00, 'Activo', 30.00, 2500.00, 33, 80, 8);
    contenedor_insertar_SP(12.00, 'Activo', 15.00, 1200.00, 202, 92, 5);
    contenedor_insertar_SP(20.00, 'Activo', 22.00, 1800.00, 80, 90, 2);
